...
1.  **Kaggle Writeup**
2.  **Media Gallery**
3.  **Attached Public Video**
4.  **Attached Project Link**
...
To create a new Writeup, click on the "New Writeup" button. After you have saved your Writeup, you should see a "Submit" button in the top right corner.
...
*   **Length:** Your Writeup should not exceed 2,500 words. Submissions over this limit may be subject to penalty.
...
| :--- | :--- | :--- |
| **Core Concept & Value** | 10 | Your project's central idea, its relevance to the track for the submission; focused on innovation and value. The use of agents should be clear, meaningful and central to your solution. |
| **YouTube Video Submission** | 10 | Your video should showcase clarity, conciseness and quality of messaging. It should articulate some of the following (within the 5-minute limit):<br>- **Problem Statement:** Describe the problem you're trying to solve, and why it's important or interesting.<br>- **Agents:** Why agents? How can agents uniquely help solve that problem?<br>- **Architecture:** Images and a description of the overall agent architecture.<br>- **Demo:** Demo of your solution (images, animation, or video of the agent working).<br>- **The Build:** How you created it, what tools or technologies you used. |
| **Writeup** | 10 | How well your written submission articulates the problem you're solving, your solution, its architecture, and your project's journey. |
...
| Criteria | Points | Description |
| :--- | :--- | :--- |
| **Technical Implementation** | 50 | Quality of your solution's architecture, your code, and the meaningful use of agents. Tool use (especially clever usage of existing toolsets) will be assessed. Code should contain comments pertinent to implementation, design, and behaviors.<br>*Note: Deployment to a live public endpoint is not required, but if deployed, please provide reproduction docs.*<br>🚨 **REMINDER: DO NOT INCLUDE ANY API KEYS OR PASSWORDS IN YOUR CODE.** |
| **Documentation** | 20 | Submission (via GitHub) should contain a `README.md` file explaining the problem, solution, architecture, setup instructions, and relevant diagrams or images. |
